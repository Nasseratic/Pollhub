...
public final class user_002dregister_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<br/>\r\n");
      out.write("<br/>\r\n");
      out.write("<div class=\"card\"  style=\"padding: 50px;\">\r\n");
      out.write("    <h2 class=\"is-size-3 has-text-centered\"> USER SIGN UP </h2>\r\n");
      out.write("    <br/>\r\n");
      out.write("    <form class=\"container\" action=\"UserController?op=signup\" method=\"POST\" style=\"max-width: 350px;\">\r\n");
      out.write("        <div class=\"field\">\r\n");
      out.write("            <div class=\"control\">\r\n");
      out.write("                <input class=\"input\" v-model=\"username\" @keyup=\"checkUserExists()\" required name=\"username\" type=\"text\" placeholder=\"User Name\">\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"field\">\r\n");
      out.write("            <div class=\"control\">\r\n");
      out.write("                <input class=\"input\" name=\"email\" type=\"text\" placeholder=\"Email\" required>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("        <div class=\"field\">\r\n");
      out.write("            <div class=\"control\">\r\n");
      out.write("                <input class=\"input\" name=\"password\" type=\"password\" placeholder=\"Password\" required>\r\n");
      out.write("            </div>\r\n");
      out.write("        </div>\r\n");
      out.write("\r\n");
      out.write("        <button class=\"button is-primary is-medium btn-text is-centered\" type=\"submit\">SIGN UP</button>\r\n");
      out.write("    </form>\r\n");
      out.write("</div>\r\n");
      out.write("<script>\r\n");
      out.write("\r\n");
      ...
      out.write("        el: \"form\",\r\n");
      out.write("        data(){\r\n");
      out.write("            return {username: \"\", isValid: true, loginError: false};\r\n");
      out.write("        },\r\n");
      out.write("        methods: {\r\n");
      out.write("            checkUserExists() {\r\n");
      out.write("                console.log(this.username);\r\n");
      out.write("                axios.get('UserController?op=unique&username=' + this.username).then(res => {\r\n");
      out.write("                    this.isValid = res;\r\n");
      out.write("                    console.log(this.username);\r\n");
      out.write("                });\r\n");
      out.write("            }\r\n");
      out.write("        }\r\n");
